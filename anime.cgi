...
if (0) {
	print <<EOF;
<IMG SRC=http://$ENV{'SERVER_NAME'}/img/kame-anime-small.gif><BR>
<FONT COLOR=#ff0000>
...
EOF
	...
	print <<EOF;
<IMG SRC=http://$ENV{'SERVER_NAME'}/img/kame-noanime-small.gif><BR>
<FONT COLOR=#ff0000>If you migrate to IPv6 HTTP,
you'll be able to view 
<A HREF=http://$ENV{'SERVER_NAME'}/kame-mosaic.html>the dancing kame</A>
</FONT>
EOF
}
exit 0;
